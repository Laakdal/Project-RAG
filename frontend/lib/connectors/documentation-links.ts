...
// ========================================
//
// Extracted from the workspace connectors admin route so the toolsets API and
// agent builder can normalize registry documentation links without coupling to
// the (deleted) admin route tree.
