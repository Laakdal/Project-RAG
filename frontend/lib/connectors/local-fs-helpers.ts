// ========================================
// Local FS connector helpers
// ========================================
//
// Extracted from the workspace connectors admin route so chat citations and
// search results can detect Local FS sources without coupling to the (deleted)
// admin route tree.
